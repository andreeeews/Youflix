  ...
  return (
    <div className="bg-gray-700 max-w-lg mx-auto border px-4 py-4 rounded-lg">
      <div className="flex items-center mb-3">
        <img
          src={avatar ? `/avatar${avatar}.png` : "/avatar0.png"}
          alt="Avatar"
          className="border-4 border-red-600 w-12 h-12 rounded-full mr-4"
        />
        <div>
  ...
  <button className="ml-auto text-red-500" onClick={handleDeleteComment}>
    Borrar
      ...
      <div className="border-t border-gray-300 my-1">
        <p className="text-lg mt-2 font-bold text-white leading-relaxed">
          {text}
        </p>
      </div>
    </div>
